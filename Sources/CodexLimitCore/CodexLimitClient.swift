    ...
    private func fetch<Response: Decodable>(_ responseType: Response.Type, from endpoint: URL) async throws -> Response {
        ...
        guard (200..<300).contains(httpResponse.statusCode) else {
            if httpResponse.statusCode == 429 {
                throw CodexLimitError.rateLimited(httpResponse.value(forHTTPHeaderField: "Retry-After"))
            }
...
public enum CodexLimitError: LocalizedError {
